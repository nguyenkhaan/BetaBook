...
export function ResignationDialog({ open, onOpenChange, onSubmit }: ResignationDialogProps) {
  ...
  useEffect(() => {
    if (formData.fromDate && formData.toDate) {
      ...
      if (to >= from) {
        ...
        setFormData(prev => ({ ...prev, daysTaken: diffDays.toString() }));
      }
    }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-gray-900">Đơn xin nghỉ việc</DialogTitle>
        </DialogHeader>
        
        <form onSubmit={handleSubmit} className="space-y-6 pt-2">
          {/* Basic Information */}
          <div className="space-y-4">
            <h3 className="text-gray-900 pb-2 border-b border-gray-200">Thông tin cơ bản</h3>
          ...
          {/* Leave Period */}
          <div className="space-y-4">
            <h3 className="text-gray-900 pb-2 border-b border-gray-200">Thời gian nghỉ</h3>
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
          ...
          {/* Resignation Details */}
          <div className="space-y-4">
            <h3 className="text-gray-900 pb-2 border-b border-gray-200">Chi tiết nghỉ việc</h3>
            <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="Lý do cá nhân">Lý do cá nhân</SelectItem>
                <SelectItem value="Thăng tiến sự nghiệp">Thăng tiến sự nghiệp</SelectItem>
                <SelectItem value="Chuyển nơi ở">Chuyển nơi ở</SelectItem>
