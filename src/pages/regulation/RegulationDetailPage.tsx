                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">
                            Xem chi tiết các quy định của Beta Book
                        </p>
                    </div>
                </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-3">
                        ...
                        <span
                            className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(regulation.status)}`}
                        >
                            {regulation.status}
                        </span>
                ...
                <div className="border-t mt-8 pt-6">
                    <p className="text-sm text-gray-500 italic">
                        * Quy định này có hiệu lực từ ngày{' '}
                        {formatDate(regulation.effectiveDate)} và có thể được
                        cập nhật theo từng thời kỳ.
                    </p>
                    <p className="text-sm text-gray-500 italic mt-2">
                        * Mọi thắc mắc vui lòng liên hệ phòng Nhân sự để được
                        giải đáp.
                    </p>
                </div>
            </div>
